...
function edit($type,$te){
  $con = getConnection();
  $sql = "insert into papertype (paperType) values ('$type')";
  $sql3 = "insert into covertheme (covertheme) values ('$te')";
...
function delete($typed,$ted){
    $con = getConnection();
    $sql2="delete from papertype where paperType='$typed'";
    $sql3="delete from covertheme where covertheme='$ted'";
...
function addadmin($password, $username){
    $con = getConnection();
    $sql = "insert into admin (password, username) values ('$password', '$username')";
